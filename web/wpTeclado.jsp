            ...
            <div class="container">
                <html:form styleId="frm_login" styleClass="form-signin form-login" action="/LoginAuxiliarAction" method="POST" >   
                    ...
                    <p class="login-top text-center">    
                        <span class="block sistema">WEB GOLDEN <br>CONTABILIDAD</span>                        
                    </p>
                    ...
                    <div class="c-boton-login">
                         <html:submit value="Ingresar" styleClass="btn btn-block btn-default boton-login"   />
                    </div>
