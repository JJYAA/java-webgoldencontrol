        ...
        <div class="container main-container">   
            <div class="widget">                   
                <div class="widget-content" id="main-content">
                    <h3>Empresa&nbsp;&nbsp;:<bean:write name="Tienda" property="nombre" /> </H3>
                    <h5 class="nmt">Holaaaa <strong><bean:write name="Usuario" property="nombre" /></strong> !</h5>
                    ...
                    <ul class="iconic nmb">
                        ...
                        <li><span class="orange"><%=Constantes.ICON_CHECK%></span><span class="icono-izq">Tipo Cambio D&oacute;lares (SAP): <bean:write name="Global" property="tipoCambioDolar" /></span></li>
                        <li><span class="orange"><%=Constantes.ICON_CHECK%></span><span class="icono-izq"><a href="http://192.168.178.221:8081/esunatdoc" target="blank"> Consulta de documentos SUNAT</a></span></li>
                    </ul>                    
