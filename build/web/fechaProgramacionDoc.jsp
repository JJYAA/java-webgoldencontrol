...
<html:html>
    ...
    <body id="main-wrapper">
            ...
            <div class="widget">
                <div class="widget-content" id="main-content">
                    <ol class="breadcrumb">
                        ...
                        <li>Programar pagos de documentos</li>
                    </ol>
                        ...
                        <c:choose>
                            <c:when test="${ProgramaPagosForm.flagMueOcuForm=='muestra'}">                                                                          
                                ...
                                <div class="accion-line aright">      
                                    ...
                                    <button title="Confirmar" id="btnGrabarPago" name="btnGrabarPago" onclick="grabarFechaPago();" class="btn btn-success"   type="button" ><%=Constantes.ICON_CHECK%> Grabar Programacion de pagos</button>                             
                                </div>  
                        ...
                        <div class="modal fade" id="modalCuentasProveedor" data-backdrop="static"  tabindex="-1" role="dialog">
                            <div class="modal-dialog  modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="panel panel-default"> 
                                            <div id="c_tablaListaCuentasBancarias"></div>   
                                        </div>   
                                        <div class="accion-line aright">                     
                                             
                                             <button title="Cerrar" id="btnConAdicionar" name="btnCerrar" onclick="cerrarHelpCuentasProveedor();" class="btn btn-sm btn-danger" type="button" ><%=Constantes.ICON_EXIT %>Cerrar</button>                                        
                                        </div>                                                                         
                                    </div>           
                                </div>
                            </div>      
       ...
       <script type="text/javascript" src="js/funciones/jsProgramaFecha.js"></script>
    </body>
</html:html>