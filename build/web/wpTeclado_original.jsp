            ...
            <div class="container">
                <html:form styleId="frm_login" styleClass="form-signin form-login" action="/LoginAuxiliarAction" method="POST" >   
                    ...
                    <div class="form-group"> 
                        <%
                            String codigoEmpresa = Util.ReadFileConfig("CodigoEmpresa", request.getSession().getServletContext().getRealPath("/"));
                        %>
                        <% request.setAttribute("listaTiendas", new ListaTiendas().listaTiendasEmpresa("%"));%>
                        <html:select property="empresa" styleId="empresa" styleClass="form-control" >
                            <option value="">----- SELECCIONE -----</option>
                            <c:forEach items="${listaTiendas}" var="obj">
                                <option value="${obj.indice}">${obj.descripcion}</option>
                            </c:forEach>
                        </html:select>
                    </div>             
                    <div class="form-group">
                        <html:select property="tienda"   styleId="tienda" styleClass="form-control"   >
                            <option value="">----- SELECCIONE -----</option>
                        </html:select>                                
                    </div>       
