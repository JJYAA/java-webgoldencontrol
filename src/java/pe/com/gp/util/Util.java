...
public final class Util {
    ...
    public static String yyyymmdd2(String STRFecha) throws Exception {
        return STRFecha.substring(6,10)  + STRFecha.substring(3,5)  + STRFecha.substring(0,2) ;
    }    
    /**
     * Suma n dias a una fecha recibida.
    ...
    public static String completarCerosIzq3(double dato, String formato) {
        DecimalFormat format = new DecimalFormat(formato);
        String str = format.format(dato);
        return str;
    }    
    
    public static String completarCerosIzq2(double dato, int longitud) throws Exception {
        String cadena = Util.nullCad(dato);        
        String str = repetirCadena("0",longitud - cadena.length()) + cadena;
        return str;
    }    
    /**
